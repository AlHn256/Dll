...
namespace ImgAssemblingLibOpenCV.AditionalForms
{
    public partial class MainForm : Form
    {
        ...
        private void Loading(object sender, EventArgs e)
        {
            ...
            _Log.DebugPrint("Programm starting");
        ...
        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            _Log.DebugPrint("Closing programm");
            SaveSettings();
        }
        ...
        private void SetNumberOfThreads_Click(object sender, EventArgs e)
        {
            ThreadsNumber threadsNumber = new ThreadsNumber(1);
            threadsNumber.Show();
