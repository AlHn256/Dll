...
namespace NewImgFixingLib
{
    public partial class ImgFixingForm : Form
    {
        ...
        public MagickImage[] FixImgArray()
        {
            MagickImage[] rezultArray = new MagickImage[0];
            if(DataArray == null && BitmapArray == null) return rezultArray;
            if(DataArray.Length == 0 && BitmapArray.Length == 0) return rezultArray;
            ...
            {
                //DataArray = BitmapArray[0].ToMagickImage();
                //var gdfg = ToMagickImage(BitmapArray[0]);
                //var dsfg = BitmapArray[0];
                
                //var m = new MagickFactory();
                ////MagickImage magick = new MagickImage(ImageUtilities.BitmapImage2Bitmap(image));
                //MagickImage image = new MagickImage(m.Image.Create(BitmapArray[0]));
